...
public class TimePicker extends DialogFragment implements
    ...
    public void onTimeSet(android.widget.TimePicker view,
        ...
        String rawTimeString =  rawHourOfTheDay + ":" +
                ((minute / 10 < 1) ? "0" + minute :
                        String.valueOf(minute)) + ":"+"00";

        timePickerEndTimeListener.updateTime(timeFormat,rawTimeString);
...
//        }
    ...
    public interface TimePickerEndTimeListener {
        void updateTime(String endTime,String rawTimeString);
    }
